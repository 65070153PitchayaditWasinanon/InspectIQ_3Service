"""
Django settings for InspectIQ_Order project.
...
SECRET_KEY = 'django-insecure-=x3ac$bwvjm*lxh-*d841xg0id%eu_oop*f*aruhvr@y-7!+v3'
...
ROOT_URLCONF = 'InspectIQ_Order.urls'
...
WSGI_APPLICATION = 'InspectIQ_Order.wsgi.application'
