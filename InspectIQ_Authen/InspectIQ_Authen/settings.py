...
ACCOUNT_EMAIL_REQUIRED = True  # บังคับให้ใส่อีเมล
ACCOUNT_EMAIL_VERIFICATION = "mandatory"  # เปิดการยืนยัน Email
ACCOUNT_CONFIRM_EMAIL_ON_GET = True  # เปิดให้คลิก link ยืนยันแล้วล็อกอินได้เลย
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = "inspect.iq.notify@gmail.com"
EMAIL_HOST_PASSWORD = "vbxo nlbv gcqv jtui"  # หรือใช้ Environment Variable